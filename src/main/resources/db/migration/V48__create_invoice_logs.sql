...
CREATE TABLE invoice_logs (
    ...
    CONSTRAINT fk_invoice_logs_appointment FOREIGN KEY (appointment_id) REFERENCES appointments(id) ON DELETE CASCADE,
    CONSTRAINT fk_invoice_logs_customer FOREIGN KEY (customer_id) REFERENCES customers(id) ON DELETE CASCADE
);
